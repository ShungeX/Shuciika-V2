                ...
                "components": [
                    ...
                    },
                    {
                        ...
                        "content": `-# ${finalContent}\n\n-# Tu secuencia de entrega: ${deliveryGame.secuenciaUser.length > 0 ? deliveryGame.secuenciaUser.join(", ") : "No acertaste ninguna"}\n\n`
                            + `-# ${soul.energy < jobData.energia ? "Te has quedado sin energía para trabajar. En unos momentos se dara tu resultado..." : `¿Deseas continuar trabajando? ` + "`" + `(-${jobData.energia}⚡)` + "`"}`
                    }
                ]
            },
            {
                ...
                "components": [
                    {
                        ...
                        "min_values": 1,
                        "max_values": 1,
                        "disabled": soul.energy < jobData.energia
                    }
                ]
            }
        ]

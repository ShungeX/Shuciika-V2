    ...
    ejecutar: async(client, interaction, character, extras) => {
        ...
        async function endDialogo() {
           ...
           await sleep(7000)
            ...
            .setImage("https://res.cloudinary.com/dn1cubayf/image/upload/v1737251458/cryinthedarkness_aalpit.jpg")
            .setColor("NotQuiteBlack")
            ...
            .setImage("https://res.cloudinary.com/dn1cubayf/image/upload/v1737340270/randomname_jj9lwg.jpg")
            .setColor("NotQuiteBlack")
            ...
            .setImage("https://res.cloudinary.com/dn1cubayf/image/upload/v1737310545/dispair_hpomor.jpg")
            .setColor("NotQuiteBlack")
            ...
            .setImage("https://res.cloudinary.com/dn1cubayf/image/upload/v1737249757/darkpj_qmhtav.jpg")
            .setColor("NotQuiteBlack")
            ...
            .setImage("https://res.cloudinary.com/dn1cubayf/image/upload/v1737310377/Last_words_of_a_shooting_star_-_Mitski_ik26ci.jpg")
            .setColor("DarkPurple")

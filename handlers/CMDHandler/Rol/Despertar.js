...
module.exports = async(client, interaction) => {
    ...
    async function dialogo() {
        ...
        .setAuthor({name: "Guardiana de las estrellas", iconURL: "https://res.cloudinary.com/dn1cubayf/image/upload/v1737249989/light_xxwmdp.jpg"})
        ...
        .setAuthor({name: "Astralea | Guardiana de las estrellas ", iconURL: "https://res.cloudinary.com/dn1cubayf/image/upload/v1737249989/light_xxwmdp.jpg"})
        ...
        .setAuthor({name: "Astralea | Guardiana de las estrellas ", iconURL: "https://res.cloudinary.com/dn1cubayf/image/upload/v1737249989/light_xxwmdp.jpg"})
        .setDescription("Fui llamada por la `Tejedora de las estrellas` para guiarte en tu despertar.")
        .setColor("DarkPurple")
        ...
        .setImage("https://res.cloudinary.com/dn1cubayf/image/upload/v1737250647/soul_kajwym.jpg")
        .setColor("DarkPurple")
        ...
        .setImage("https://res.cloudinary.com/dn1cubayf/image/upload/v1737250923/yoursoul_dpr7gt.jpg")
        .setColor("DarkPurple")
        ...
        .setAuthor({name: "¿Firmamento?", iconURL: "https://res.cloudinary.com/dn1cubayf/image/upload/v1737249982/darkpj_2_uhrvyj.jpg"})

const { EmbedBuilder, ButtonBuilder, ActionRowBuilder, ButtonStyle, ChatInputCommandInteraction, Client, StringSelectMenuBuilder, SlashCommandSubcommandBuilder } = require(`discord.js`)
...
module.exports = {
    ...
    ejecutar: async (client, interaction, { character, soul }) => {
        ...
        async function dialogo() {
            ...
            message.edit({ content: "*la oscuridad te envuelve y te atrapa lentamente...*" })
            ...
            const embed2 = new EmbedBuilder()
                ...
                .setDescription("Soy Astralea una `Guardiana de las estrellas` forjadora de caminos entre lo efimero y lo eterno. Protectora de aquellos que buscan su luz.")
                .setColor("DarkPurple")
            ...
            const embed3 = new EmbedBuilder()
                .setAuthor({ name: "Astralea | Guardiana de las estrellas ", iconURL: "https://res.cloudinary.com/dn1cubayf/image/upload/f_auto,q_auto,w_300,h_300,c_fill/light_xxwmdp" })
                .setDescription("Fui llamada por el `eón creador` para guiarte en tu despertar.")
                .setColor("DarkPurple")

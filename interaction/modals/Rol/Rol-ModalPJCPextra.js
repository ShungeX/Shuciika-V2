    ...
    ejecutar: async(client, interaction) => {
        ...
        if(imgURL) {
          if(await isValidImage() === false) {
            return interaction.reply({ content: "Tu link parece no ser valido, verifica que contenga una imagen valida. Si tienes dudas revisa el foro <#1065148731164475413>", flags: ["Ephemeral"]})
          }else {
